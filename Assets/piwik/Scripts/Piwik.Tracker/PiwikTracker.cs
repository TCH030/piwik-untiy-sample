...
namespace Piwik.Tracker
{
    ...
    ///
    ///      $t = new PiwikTracker( $idSite = 7, 'http://ti15eb.asuscomm.com/piwik');
    ///
    ...
    public class PiwikTracker
    {
        ...
        /// </summary>
        /// <param name="idSite">7</param>
        /// <param name="apiUrl">"http://ti15eb.asuscomm.com/piwik"</param>
        ...
        public PiwikTracker(int idSite, string apiUrl)
        {
            ...
            {
                throw new ArgumentException("Piwik api url must not be emty or null.", apiUrl);
            }
        ...
        /// <summary>
        /// Gets the Piwik base URL, for example http://ti15eb.asuscomm.com/piwik
        /// </summary>
        ...
        /// </summary>
        public TimeSpan RequestTimeout  = TimeSpan.FromSeconds(600);
        ...
        /// </summary>
        /// <param name="url">"https://ti15eb.asuscomm.com/index.html"</param>
        ...
        /// </summary>
        /// <param name="url">"https://ti15eb.asuscomm.com/java_tracker.html"</param>
        ...
        public void SetCustomVariable(int id, string name, string value, Scopes scope = Scopes.Visit)
        {
            ...
            switch (scope)
            {
                ...
                default:
                    throw new ArgumentException("Invalid 'scope' parameter value", scope.ToString());
            }
        }
       ...
       //     }
        ...
        /// </summary>
        /// <param name="userAgent">unity3d</param>
        ...
        /// </summary>
        /// <param name="domain">"http://ti15eb.asuscomm.com"</param>
        ...
        protected string GetCookieName(string cookieName)
        {
            ...
            var hash = GetHexStringFromBytes(new SHA1CryptoServiceProvider().ComputeHash(Encoding.UTF8.GetBytes(( (_configCookieDomain==null|| _configCookieDomain.Equals("")) ? GetCurrentHost() : _configCookieDomain) + _configCookiePath))).Substring(0, 4);
        ...
        /// Tracks a page view
        /// </summary>
        /// <param name="documentTitle">shoping car</param>
        /// <returns>"http://ti15eb.asuscomm.com/shoppingcar.html</returns>
        public TrackingResponse DoTrackPageView(string documentTitle = null)
        {
            Debug.Log("DEBUG_LAST_REQUESTED_URL :"+ documentTitle);
        ...
        public void AddEcommerceItem(string sku, string name = "", List<string> categories = null, double price = 0, ulong quantity = 1)
        {
            ...
            {
                throw new ArgumentException("You must specify a SKU for the Ecommerce item", sku);
            }
        ...
        public TrackingResponse DoBulkTrack()
        {
            ...
            if (!(_tokenAuth==null|| _tokenAuth.Equals("")))
            {
                data["token_auth"] = _tokenAuth;
            }

            var postData = Json.Serialize(data);
        ...
        public void SetEcommerceView(string sku = "", string name = "", List<string> categories = null, double price = 0)
        {
            ...
            if (categories != null)
            {
                serializedCategories = Json.Serialize(categories);
            }
        ...
        public string GetUrlTrackEcommerceOrder(string orderId, double grandTotal, double subTotal = 0, double tax = 0, double shipping = 0, double discount = 0)
        {
            ...
            {
                throw new ArgumentException("You must specifiy an orderId for the Ecommerce order", orderId);
            }
        ...
        protected string GetUrlTrackEcommerce(double grandTotal, double subTotal = 0, double tax = 0, double shipping = 0, double discount = 0)
        {
            ...
            {
                url += "&ec_items=" + UrlEncode(Json.Serialize(_ecommerceItems.Values));
            }
        ...
        public string GetUrlTrackEvent(string category, string action, string name = "", string value = "")
        {
            ...
            {
                throw new ArgumentException("You must specify an Event Category name (Music, Videos, Games...).", category);
            }
            if (action == null || action.Trim().Equals("") )
            {
                throw new ArgumentException("You must specify an Event action (click, view, add...).", action);
            }
        ...
        public string GetUrlTrackContentImpression(string contentName, string contentPiece, string contentTarget)
        {
            ...
            {
                throw new ArgumentException("You must specify a content name", contentName);
            }

            var url = GetRequest(IdSite);
            url += "&c_n=" + UrlEncode(contentName);

            if (!(contentPiece == null || contentPiece.Trim().Equals("")))
            {
                url += "&c_p=" + UrlEncode(contentPiece);
            }
            if (!(contentTarget == null || contentTarget.Trim().Equals("")))
            {
        ...
        {
            if (interaction == null || interaction.Trim().Equals("") )
            {
                throw new ArgumentException("You must specify a name for the interaction", interaction);
            }
        ...
        public void SetUserId(string userId)
        {
            ...
            {
                throw new ArgumentException("User ID must not be empty or null.", userId);
            }
            _userId = userId;
        }
        ...
        /**
        private object GetCookieMatchingName(string name) {
            return null;
        }
        ...
        public AttributionInfo GetAttributionInfo()
        {
            ...
            var cookieDecoded = Json.Deserialize<string[]>(HttpUtility.UrlDecode(refCookie.Value ?? string.Empty));
     ...
     */
        ...
        private TrackingResponse SendRequest(string url, string method = "GET", string data = null, bool force = true)
        {
        ...
        /// </summary>
        /// <param name="url">"https://ti15eb.asuscomm.com/piwik"</param>
        /// <returns></returns>
        ...
        private string GetRequest(int idSite)
        {
           // SetFirstPartyCookies();
            ...
            var url = PiwikBaseUrl +
                    ...
                    "&rec=1" +
                    "&apiv=" + Version +
                    "&r=" + new System.Random().Next(0, 1000000).ToString("000000") +
               ...
               //     ((_lastEcommerceOrderTs != null) ? "&_ects=" + _lastEcommerceOrderTs : "") +
                  ...
                  //  (!string.IsNullOrEmpty(_plugins) ? _plugins : "") +
                    ...
                    (_visitorCustomVar.Any() ? "&_cvar=" + UrlEncode(Json.Serialize(_visitorCustomVar)) : "") +
                    (_pageCustomVar.Any() ? "&cvar=" + UrlEncode(Json.Serialize(_pageCustomVar)) : "") +
                    (_eventCustomVar.Any() ? "&e_cvar=" + UrlEncode(Json.Serialize(_eventCustomVar)) : "") +
        ...
        protected void SetFirstPartyCookies()
        {
            ...
            {
                SetCookie("ref", UrlEncode(Json.Serialize(attributionInfo.ToArray())), ConfigReferralCookieTimeout);
            }
            ...
            // Set the 'cvar' cookie
            SetCookie("cvar", UrlEncode(Json.Serialize(_visitorCustomVar)), ConfigSessionCookieTimeout);
        }
        ...
        protected Dictionary<string, string[]> GetCustomVariablesFromCookie()
        {
            ...
            return Json.Deserialize<Dictionary<string, string[]>>(HttpUtility.UrlDecode(cookie.Value ?? string.Empty));
        }
        */
        ...
        private string UrlEncode(string value)
        {
            ...
            byte[] byStr = System.Text.Encoding.UTF8.GetBytes(value); //默认是System.Text.Encoding.Default.GetBytes(str)
